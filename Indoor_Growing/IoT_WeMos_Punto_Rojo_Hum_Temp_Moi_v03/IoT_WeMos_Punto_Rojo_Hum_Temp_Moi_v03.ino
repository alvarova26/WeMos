...
char clrc = 'u';                                  //Clear code (t=temperarutr | h=humidity | m=moisture) sent to auxiliar functions clear_mem()
...
void hum_logic()
{
  ...
  {
    hum_sen_sta = 0;
    hum_mem = mem_logic(hum_raw, hum_ini_mem, 't'); //Call mem_logic() => Calculate average of last 5 previous values
    print_measurements(hum_raw, hum_mem, hum_cor, 't' ); //Call print_measurements()
...
void moi_logic()
{
  ...
  else
  {
    ...
    moi_mem = mem_logic(moi_raw, moi_ini_mem, 't'); //Call mem_logic() => Calculate average of last 5 previous values
    print_measurements(moi_raw, moi_mem, moi_cor, 't' ); //Call print_measurements()
