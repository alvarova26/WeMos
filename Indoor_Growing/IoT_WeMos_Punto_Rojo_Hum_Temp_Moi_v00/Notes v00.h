...
/* ############################## Version Index
IoT_WeMos_Punto_Rojo_Hum_Temp_Ctrl_v00 => Initial version
IoT_WeMos_Punto_Rojo_Hum_Temp_Ctrl_v01 => Security version (Larika almost deletes all the code, so just in case...)
*/
...
MOI     =>  Even in some site I found that it is recommended to feed the sensor with 5v, the current project considers 3.3v.
            ...
            As 20210629, cloudy day here in Salvador, Bahia, I've measured:
            AirValue = 664
            Water Value = 
*/  
